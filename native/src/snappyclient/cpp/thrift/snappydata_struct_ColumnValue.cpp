...
void ColumnValue::printTo(std::ostream& out) const {
  ...
  switch (m_type) {
    ...
    case SnappyType::DOUBLE:
      ...
      break;
    case SnappyType::VARCHAR:
      out << "string_val=" << to_string(*m_uval.string_binary_java_val);
      break;
    case SnappyType::DECIMAL:
      out << "decimal_val=" << to_string(*m_uval.decimal_val);
      break;
    case SnappyType::DATE:
      out << "date_val=" << to_string(DateTime(m_uval.date_time_epoch_val));
      break;
    case SnappyType::TIME:
      out << "time_val=" << to_string(DateTime(m_uval.date_time_epoch_val));
      break;
    case SnappyType::TIMESTAMP:
      out << "timestamp_val=" << to_string(Timestamp(
          m_uval.timestamp_val.epochTime, m_uval.timestamp_val.nanos));
      break;
    case SnappyType::BINARY:
    ...
    case SnappyType::CLOB:
      ...
      break;
    case SnappyType::ARRAY:
      out << "array_val=(" << to_string(*m_uval.array_val) << ")";
      break;
    case SnappyType::MAP:
      out << "map_val=(" << to_string(*m_uval.map_val) << ")";
      break;
    case SnappyType::STRUCT:
      out << "struct_val=(" << to_string(*m_uval.struct_val) << ")";
      break;
    case SnappyType::NULLTYPE:
