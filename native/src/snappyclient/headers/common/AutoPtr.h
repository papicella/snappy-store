...
namespace snappydata {
  ...
  public:
     ...
     */
    explicit AutoPtr(T* p = 0) throw () : m_pOrig(p), m_p(p) {
    }
     ...
     */
    AutoPtr(const AutoPtr& o) throw () : m_pOrig(o.m_pOrig), m_p(o.m_p) {
    ...
    AutoPtr(const AutoPtr<T1>& o) throw () : m_pOrig(o.m_pOrig), m_p(o.m_p) {
